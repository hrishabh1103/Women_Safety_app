...
class FakeCallScreen extends StatefulWidget {
  ...
  final String fakeCallerName; // Use final to pass value via constructor

  // Constructor to receive fakeCallerName
...
class _FakeCallScreenState extends State<FakeCallScreen> {
  ...
  void initState() {
    super.initState();
    // Play ringtone when the screen is created
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                widget.fakeCallerName, // Use widget to access the passed parameter
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 25.0,
                ),
