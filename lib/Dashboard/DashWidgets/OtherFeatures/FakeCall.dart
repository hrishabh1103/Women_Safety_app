  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Card(
        ...
        child: InkWell(
          onTap: () {
            // Remove the const here as 'Fake' widget might not be const
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  // The CircleAvatar widget and its Image should not be const
                  CircleAvatar(
                    backgroundColor: Colors.white.withOpacity(0.5),
                    radius: 25,
                    child: Center(
                      child: Image.asset(
                        "assets/call.png", // Ensure this image exists in the assets folder
                        height: 35,
                      ),
                    ),
                  ),
